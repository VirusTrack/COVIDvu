...
export const HeaderContainer = () => {
  ...
  const LocalizedNavMenu = () => (
    <Navbar.Item onClick={() => { clientCountry.countryISO === 'US' ? changePage('/covid/us') : changePage(`/covid/country/${clientCountry.country}`) }}>
      ...
      {clientCountry.countryISO === 'US' ? 'United States' : clientCountry.country}
    </Navbar.Item>
  )
  ...
  return (
    <>
      <div className="meta-nav">
        ...
        <p>
          { false && `Due to problems with one of our data sources, all data on the site at the moment is for yesterday 03/25. Our amazing volunteer team is in the middle of fixing this linkage and
      ...
      <Navbar>
        ...
        <Navbar.Menu>
          <Navbar.Segment align="start">
            <Navbar.Item active={selectedNav === '/dashboard'} onClick={() => { changePage('/dashboard') }}>
              <img src={compassImg} alt="Compass" />
              Dashboard
            </Navbar.Item>
            <Navbar.Item active={selectedNav === '/covid'} onClick={() => { changePage('/covid') }}>
            ...
            <Navbar.Item active={selectedNav === '/stats'} onClick={() => { changePage('/stats') }}>
          ...
          <Navbar.Segment align="end">
            ...
            <Navbar.Item active={selectedNav === '/about'} onClick={() => { history.push('/about') }}>
              <img src={infoImg} alt="About Site" />
              About
            </Navbar.Item>
          </Navbar.Segment>
        </Navbar.Menu>
