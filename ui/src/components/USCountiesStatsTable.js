...
import { Select, Level, Title, Generic, Table, Tab } from 'rbx'
...
export const USCountiesStatsTable = ({filterRegion = 'NY', statsForGraph, redirectToExternalLink, isExternalLinkAvailable, renderDisplay, onSelectedFilter, sort, onSort}) => {
    ...
    return (
        <>
        <Level style={{marginBottom: 0, marginTop: 0, paddingTop: 0, paddinBottom: 0}}>
            <Level.Item>
                <Select.Container>
