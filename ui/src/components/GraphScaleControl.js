      ...
      <Column.Group style={{ alignItems: 'baseline', justifyContent: align, marginRight: '1rem' }} breakpoint="mobile" multiline>
        ...
        <Column narrow>
          <Button.Group hasAddons>
            ...
            <Button disabled={showPredictions} size="medium" selected={graphScale === GRAPHSCALE_TYPES.AVERAGE} color={graphScale === GRAPHSCALE_TYPES.AVERAGE ? 'default' : 'light'} onClick={() => { if (graphScale !== GRAPHSCALE_TYPES.AVERAGE) { handleGraphScale(GRAPHSCALE_TYPES.AVERAGE) } }}>New Cases</Button>
