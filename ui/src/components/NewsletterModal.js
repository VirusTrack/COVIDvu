...
import { Box, Title, Tag, Column } from 'rbx'
  ...
  return (
    ...
    >
      <Column.Group breakpoint="mobile" style={{marginBottom: 0}}>
        <Column><Title style={{marginBottom: 0, color: '#0F0F0F', fontWeight: 600, textAlign: 'left', fontFamily: 'Archivo', fontSize: '2.4rem'}} as="div">Sign up for our Newsletter</Title></Column>
        {handleModalClose && <Column narrow><Tag delete size="large" onClick={handleClose} style={{display: 'block', marginLeft: 'auto', color: '#444444', background: '#EFEFEF'}}/></Column>}
      </Column.Group>
